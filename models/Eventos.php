...
class Eventos extends ActiveRecord{
    ...
    public function validar() {
        if(!$this->nombre && !$this->descripcion && !$this->categoria_id && !$this->dia_id && !$this->hora_id && !$this->disponibles && !$this->ponente_id){
            self::$alertas['error'][] = 'Debes llenar todos los campos del formulario';
        } else{
            if(!$this->nombre) {
