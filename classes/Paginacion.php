...
class Paginacion{
    ...
    function __construct($pagina_actual = 1, $registros_por_pagina = 10, $total_registros = 0){
    ...
    public function numeros_paginas(){
        ...
        for($n = 1; $n <= $this->total_paginas(); $n++){
            if($n === $this->pagina_actual){
                $html .= "<span class=\"paginacion__enlace paginacion__enlace--actual\">{$n}</span>";
            } else{
                $html .= "<a class=\"paginacion__enlace paginacion__enlace--numero\" href=\"?page={$n}\">{$n}</a>";
            }
        }
