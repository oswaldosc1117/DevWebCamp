...
<section class="speakers">
    ...
    <div class="speakers__grid">
        <?php foreach($ponentes as $ponente): ?>
            <div class="speaker" <?php aos_animacion(); ?>>
                ...
                <div class="speaker__informacion">
                    ...
                    <div class="speaker-sociales">
                        ...
                        <?php endif; ?>
                    </div> <!--Cierre de speaker-sociales__sociales-->
            ...
            </div> <!--Cierre de speaker-->
        <?php endforeach; ?>
    </div> <!--Cierre de speakers__grid-->
</section> <!--Cierre de speakers-->

<div class="mapa" id="mapa"></div>

<section class="boletos">
    <h2 class="boletos__heading">Boletos & Precios</h2>
    <p class="boletos__descripcion">Boletos para DevWebCamp</p>
